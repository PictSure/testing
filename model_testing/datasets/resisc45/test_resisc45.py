#!/usr/bin/env python3
"""Eight remote-sensing scene categories at 1, 3 and 5 shots.

Higher-resolution overhead imagery than EuroSAT, with recognizable structures
(airplanes, harbors, stadiums) rather than texture-like land cover - so this
should be the easier of the two satellite tasks.

    python3 model_testing/datasets/resisc45/download.py
    python3 model_testing/datasets/resisc45/test_resisc45.py
"""
import sys
